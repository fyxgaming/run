...
describe('Json', () => {
  ...
  describe('_decode', () => {
    ...
    it.skip('throws if bad arbitrary object', async () => {
      ...
      decodeFail({ $arb: {} })
      decodeFail({ $arb: [] })
      decodeFail({ $arb: true, T: { $jig: 0 } }, 'Invalid $arb', x => CA)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, 'Not a jig', x => null)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, undefined, x => a)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, undefined, x => b)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, undefined, x => c)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, undefined, x => CB)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, undefined, x => CC)
      decodeFail({ $arb: {}, T: { $jig: 0 } }, 'Not code', x => cf)
    })
