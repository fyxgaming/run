...
function ownerScript (owner) {
  ...
  if (typeof owner === 'string') {
    ...
    try {
      const network = bsvNetwork(activeRunInstance().blockchain.network)
      new bsv.Address(owner, network) // eslint-disable-line
...
const Protocol = __webpack_require__(8)
...
const Code = __webpack_require__(32)
const Syncer = __webpack_require__(35)
const Evaluator = __webpack_require__(15)
const { Transaction } = __webpack_require__(17)
...
const DeterministicEvaluator = __webpack_require__(70)
...
AddressScript.originTestnet = 'd19e4a8a2659f810661e397bb1d3f7f59ce786a4dcce377027429749e23344b5_o1'
AddressScript.locationTestnet = 'd19e4a8a2659f810661e397bb1d3f7f59ce786a4dcce377027429749e23344b5_o1'
AddressScript.ownerTestnet = 'mmi1pQpxBapUeT2UkimMVAowSFEPADhNsN'
AddressScript.originMainnet = '5f0bff528a5be3a2681d49b5a6dff3ddee558faf07eca26447ff093cf6f4de8d_o1'
AddressScript.locationMainnet = '5f0bff528a5be3a2681d49b5a6dff3ddee558faf07eca26447ff093cf6f4de8d_o1'
AddressScript.ownerMainnet = '1DFgNkdFDon7iUT9DPpY7r6AFYrAN5N9i3'
...
PubKeyScript.originTestnet = '3bed4b59b8a4c475a0322d6f98ac5dce0abc0aedf216fa5b6195e2472699fbeb_o1'
PubKeyScript.locationTestnet = '3bed4b59b8a4c475a0322d6f98ac5dce0abc0aedf216fa5b6195e2472699fbeb_o1'
PubKeyScript.ownerTestnet = 'mu8Y36qE8d9vpCRN77assvioD2vJS8gnsH'
PubKeyScript.originMainnet = 'b36ae3757c2f57de01da8f2bfede0a97f3db974eb9fb65941ad7f2efea34ff04_o1'
PubKeyScript.locationMainnet = 'b36ae3757c2f57de01da8f2bfede0a97f3db974eb9fb65941ad7f2efea34ff04_o1'
PubKeyScript.ownerMainnet = '1Fytb1vq6SZZok9kwQMV2f3e653s4Vn7M9'
...
//  -Does FriendlySet need special handling for Set?
//  -Hook up to existing code (And FriendlySet as default)
...
class Xray {
  ...
  scanAndReplace (x) {
    this.scan(x)
    if (this.replaceToken && Protocol.isPickup(x)) {
...
class ArbitraryObjectScanner {
  ...
  isArbitraryObject (x, xray) {
    if (typeof x !== 'object' || !x) return false
    if (Protocol.isPickup(x)) return false
    if (!deployable(x.constructor, xray)) return false
    if (Protocol.isPickup(x.constructor)) {
...
class Context {
  ...
  static get Protocol () { return __webpack_require__(8) }
  ...
  static get friendlyKey () { return __webpack_require__(3).friendlyKey }
  static get friendlyPrivateData () { return __webpack_require__(3).friendlyPrivateData }
...
const ses = __webpack_require__(16)
...
class Code {
  ...
  installJig () {
    // Jigs don't use FriendlySet and FriendlyMap, because it makes
    const env = { JigControl, Context, Set, Map }
    this.Jig = this.sandboxType(Jig, env).result
  ...
  installBerry () {
    ...
    this.Berry = this.sandboxType(Berry, env).result
...
const { ProtoTransaction } = __webpack_require__(17)
const { JigControl } = __webpack_require__(4)
const { Owner } = __webpack_require__(7)
const Xray = __webpack_require__(9)
const util = __webpack_require__(0)
...
function parseFeePerKb (feePerKb) {
  switch (typeof feePerKb) {
    case 'number':
      ...
      if (feePerKb < 0) throw new Error(`Option feePerKb must be non-negative: ${feePerKb}`)
      return feePerKb
    case 'undefined':
