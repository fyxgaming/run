...
function ownerScript (owner) {
  ...
  const { AddressScript } = __webpack_require__(6)
...
function setupBsvLibrary (network) {
  ...
  // Disable signature errors, because we support custom scripts
  bsv.Transaction.Input.prototype.clearSignatures = () => {}
  bsv.Transaction.Input.prototype.getSignatures = () => []
  bsv.Transaction.Input.prototype.isFullySigned = () => false
  bsv.Transaction.Input.prototype.isValidSignature = () => false
