    ...
    if (this._returnsWrappedIterator) {
      class WrappedIterator {
        ...
        next () {
          ...
          const ret = { value: n.value, done: n.done }
          if (handler && handler._nativeOut && ret.value) {
            ret.value = handler._nativeOut(ret.value)
          }
          return ret
        }
      }
      ...
      // TODO: Sandbox
      return new WrappedIterator(ret)
    }
