...
class Proxy2 {
  ...
  get (target, prop, receiver) {
    ...
    if (isIntrinsicGetter) {
      ...
      // Convert the intrinsic's value if necessary
      const intrinsicValue = Reflect.get(target, prop, target)
      return this._handler._intrinsicOut ? this._handler._intrinsicOut(intrinsicValue) : intrinsicValue
    }
