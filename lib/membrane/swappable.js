 ...
 * swappable.js
 *
 * Flexible membrane whose inner implementation may be swapped out
 */
...
class SwappableMembrane {
  constructor () {
    this._inner = new BaseMembrane()
  }
  ...
  preventExtensions (target) {
    return this._innre.preventExtensions(target)
  }
...
module.exports = SwappableMembrane
