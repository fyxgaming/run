 ...
 * code.js
 *
 * Membrane for non-native code, including jigs and sidekicks
 */
...
// ------------------------------------------------------------------------------------------------
// Code EnableCodeMethods
// ------------------------------------------------------------------------------------------------

class EnableCodeMethods extends Membrane {
  ...
  get (target, prop, receiver) {
    if (isNonNativeCode(receiver) && CODE_METHOD_NAMES.includes(prop)) {
  ...
  ownKeys (target) {
    // Code methods are not owned properties and require no special handling
...
module.exports = EnableCodeMethods
