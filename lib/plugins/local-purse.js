...
class LocalPurse extends PurseWrapper {
  ...
  async pay (rawtx, parents) {
    ...
    return await payWithUtxos(rawtx, parents, utxos, this.blockchain, this.bsvPrivateKey, this.bsvAddress,
...
async function payWithUtxos (rawtx, parents, utxos, blockchain, privateKey, address, feePerKb,
  splits, jigFilter) {
