...
const {
  _dedupRequest, _cacheResponse, _dedupUtxos,
  _addToBroadcastCache, _updateUtxosWithBroadcasts
...
class RunConnect {
  ...
  async broadcast (rawtx) {
    ...
    this._broadcasts = _addToBroadcastCache(this._broadcasts, txid, INDEXING_DELAY)
  ...
  async utxos (script) {
    ...
    return _updateUtxosWithBroadcasts(this._broadcasts, utxos, bsvScript)
  }
