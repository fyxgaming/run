 ...
 *
 *    new WrappedBlockchain(myBlockchain)
 *
 * or extend your class from it:
 *
 *    class MyBlockchain extends WrappedBlockchain { ... }
 */
...
class WrappedBlockchain {
  ...
  setWrappingEnabled (enabled) {
    if (enabled) {
      this.broadcast = WrappedBlockchain.prototype.wrappedBroadcast
      this.fetch = WrappedBlockchain.prototype.wrappedFetch
      this.utxos = WrappedBlockchain.prototype.wrappedUtxos
      this.spends = WrappedBlockchain.prototype.wrappedSpends
      this.time = WrappedBlockchain.prototype.wrappedTime
    } else {
...
module.exports = WrappedBlockchain
