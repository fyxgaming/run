...
const stableJSONStringify = require('./stringify')
...
const _deterministicJSONStringify = (value, replacer, space) => stableJSONStringify(value, replacer, space, _deterministicCompareKeys)
