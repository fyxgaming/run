...
const { _basicUint8Array } = require('../util/misc')
 ...
 */
function _stableJSONStringify (value, replacer, space, cmp = null, nativeStringify = JSON.stringify) {
...
const _deterministicJSONStringify = (value, replacer, space) => _stableJSONStringify(value, replacer, space, _deterministicCompareKeys)
