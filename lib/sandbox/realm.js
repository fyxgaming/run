...
const { _makeDeterministic, _nonDeterministicIntrinsics } = require('./determinism')
...
class DeterministicRealm {
  constructor () {
    const makeDet = `var n=${stableJSONStringify.toString()};var m=${_makeDeterministic.toString()};m(n);`
    const setup = `(()=>{
      ${ses};
      ${makeDet};
      SES.lockdown();
