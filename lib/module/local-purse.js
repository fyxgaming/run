...
class LocalPurse {
  ...
  async pay (txhex, remaining = 0) {
    ...
    if (satoshisSpentBefore - satoshisReceivedBefore >= tx.toBuffer().length * _feeFactor + remaining) {
    ...
    Log._debug(TAG, 'Paid', paid, 'satoshis, about', tx.getFee(), 'in fees')
