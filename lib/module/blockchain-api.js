...
const { _bsvNetwork, info, warn } = require('../util')
  ...
  _dedupUtxos (utxos) {
    ...
    return utxos.filter(utxo => {
      ...
      if (!locations.has(location)) {
        ...
        warn(this.logger, `Duplicate utxo returned from server: ${location}`)
        return false
      }
    })
  }
