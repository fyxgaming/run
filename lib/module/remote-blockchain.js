...
class RemoteBlockchain {
  ...
  constructor (options = {}) {
    ...
    this.timeout = _parseTimeout(options.timeout)
...
RemoteBlockchain.create = (options = {}) => {
  ...
  const WhatsOnChain = require('./mattercloud')
  const MatterCloud = require('./whatsonchain')
...
RemoteBlockchain._parseTimeout = _parseTimeout
