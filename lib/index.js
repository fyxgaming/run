...
class Run {
  constructor (options = {}) {
    ...
    this._kernel.logger = parseLogger(options.logger)
    this._kernel.blockchain = parseBlockchain(options, this.logger)
    this._kernel.purse = parsePurse(options.purse, this)
  ...
  get logger () { return this._kernel.logger }
  get blockchain () { return this._kernel.blockchain }
  get purse () { return this._kernel.purse }

  set logger (logger) { this._kernel.logger = parseLogger(logger) }
  set purse (purse) { this._kernel.purse = parsePurse(purse, this) }

  activate () { this._kernel.activate(); return this }
  deactivate () { this._kernel.deactivate(); return this }
}
