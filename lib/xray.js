...
class Xray {
  ...
  cloneable (x) {
    ...
    if (!this.errorObject) this.errorObject = x
    return false
  }
  ...
  clone (x) {
    ...
    throw new Error(`${display(this.errorObject || x)} cannot be cloned`)
  }
  ...
  serialize (x) {
    ...
    throw new Error(`${display(this.errorObject || x)} cannot be serialized`)
  }
  ...
  deserialize (x) {
    ...
    throw new Error(`${display(this.errorObject || x)} cannot be deserialized`)
  }
