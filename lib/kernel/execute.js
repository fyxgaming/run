...
const { _checkState, _setOwnProperty, _parentName } = require('../util/misc')
...
function _execute (cmd, data, masterList) {
  ...
  CURRENT_RECORD._multiple(() => {
    switch (cmd) {
      case 'deploy': return _executeDeploy(cmd, data, masterList)
...
function _executeDeploy (cmd, data, masterList) {
