 ...
 * creation.js
 *
 * Common base class for jigs, sidekicks, and berries
 */
 ...
 *      - Berries (objects)
 *
 * All creations have a location. They can be referenced in transactions. They have membranes
 * and their actions are tracked internally by Run. Not all creations however will have a
 * owner, origin, nonce, or satoshis. Specifically, berries only have a location.
 */
class Creation {
