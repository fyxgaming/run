...
class Record {
  constructor () {
    ...
    // Bindings called moments to locate incoming creationgs in space and time
  ...
  /**
   * Saves the moment bindings of a jig
   */
  _captureMoment (jig) {
    if (this._moments.has(jig)) return
    const moment = _sudo(() => {
      return {
