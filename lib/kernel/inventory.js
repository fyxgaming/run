...
const { TokenSet, _tokenSetHasLocation, _tokenSetHasOrigin, _tokenSetDeleteOrigin } =
...
class Inventory {
  ...
  async _syncLatest () {
    ...
    for (const location of locations) {
      ...
      if (_tokenSetHasOrigin(this._tokens, token.origin)) {
        _tokenSetDeleteOrigin(this._tokens, token.origin)
      }
