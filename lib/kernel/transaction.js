...
class Transaction {
  ...
  rollback () {
    ...
    this._record._rollback(this._kernel._publisher._lastPosted, this._kernel, false, 'intentional rollback')
  }

  async sign () { await this._record.sign(this._kernel) }

  async pay () { await this._record.pay(this._kernel) }
