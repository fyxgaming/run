...
const { info, error, _tokenType, _display, _deepReplaceObjects } = util
  ...
  async import (tx, kernel, preexistingJig, immutable, vout, cache) {
    ...
    */
    ...
    const dedupInnerRefs = jig => {
      ...
      JigControl.disableSafeguards(() =>
        _deepReplaceObjects(jig, tokenReplacer, kernel._code._sandboxIntrinsics))
    }
