...
const { _assert, _checkState, _text, _kernel, _Timeout, _checkArgument } = require('../util/misc')
...
class Transaction {
  ...
  update (callback) {
    ...
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'update disabled during atomic update')
  ...
  pay () {
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'pay disabled during atomic update')
  ...
  sign () {
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'sign disabled during atomic update')
  ...
  publish (options = { }) {
    ...
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'publish disabled during atomic update')
  ...
  export (options = {}) {
    ...
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'export disabled during atomic update')
  ...
  rollback () {
    ...
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'rollback disabled during atomic update')
