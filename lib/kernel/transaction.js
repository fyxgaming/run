...
class Transaction {
  ...
  pay () {
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'pay disabled during atomic transaction')
  ...
  sign () {
    _checkState(!Transaction._ATOMICALLY_UPDATING, 'sign disabled during atomic transaction')
