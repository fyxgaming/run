...
class Transaction {
  ...
  _onReadyForPublish () {
    ...
    this._kernel._syncer._enqueueToPublish(this._record)
    this._record = new Record(this._onReadyForPublish.bind(this))
  }
  ...
  import (tx) {
    ...
    return this._activeRecord._import(tx, this._kernel, false)
  }

  rollback () {
    Log._info(TAG, 'Rollback')
    this._activeRecord.rollback(this._kernel._syncer._lastPosted, this._kernel, false, 'intentional rollback')
  }
