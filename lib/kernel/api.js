...
class Owner {
  /**
   * The next owner assigned to new resources.
   *
   ...
   */
  get owner () { throw new NotImplementedError() }
  ...
  static [Symbol.hasInstance] (instance) {
    ...
    if (typeof instance.owner !== 'string' && !(instance.owner instanceof Lock) &&
      !Array.isArray(instance.owner)) return false
    return true
  }
}
