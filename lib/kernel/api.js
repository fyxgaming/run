...
class Blockchain {
   ...
   * script hash is calculated via `sha256(script.toBuffer()).toString('hex')`. To reduce
   * computation, this method may use `script.hash` to cache the script hash.
   *
...
module.exports = { Blockchain, Purse, Lock, Key }
