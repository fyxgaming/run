 ...
 *
 *      tx://<txid>               transaction
 *      time://<txid>             transaction time in ms since unix epoch
 *      spend://<location>        spending transaction id
 *      jig://<location>          jig state at a particular location
 *      berry://<location>        berry state at a particular location
 *      ban://<location>          unloadable location
 *      config://<key>            local configuration setting
 *
