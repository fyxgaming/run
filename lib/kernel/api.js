...
class Purse {
   ...
   * @param {Array<string>} inputs Transactions spent in the inputs, stored as hex
   * @param {number} spent Amount spent as inputs in the transaction
   * @returns {string} Paid transaction in hex
   */
  async pay (txhex, inputs, spent) { throw new NotImplementedError() }
...
class Owner {
   ...
   */
  async sign (txhex, inputs, locks) { throw new NotImplementedError() }
