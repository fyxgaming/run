...
class Owner {
   ...
   *
   * This determines whether its new token that we own get added to the inventory.
   ...
   *
   * This determines the existing set of tokens in our inventory when we sync. Usually
   * it will be the UTXO set for the locks, but it may be a cached location set that
   * gets updated whenever transactions are broadcasted.
