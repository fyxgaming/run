...
class Purse {
   ...
   *    If a UTXO is null, then Run doesn't know about that input and it's not relevant to this
   *    method. Each jig UTXO will have a lock assigned to it. This lock is the owner of the jig,
   *    and it is essentially a higher-level representation of the script.
