...
class Rules {
  constructor () {
    // The owning parent jig if it exists (undefined = current, null = none)
    this._parentJig = undefined
  ...
  static _childProperty (parentJig, method) {
    ...
    rules._thisless = parentRules._thisless // Would inherit to both static + prototype methods
