...
const { _jigMapKey, _jigInMapKeys, _indexOfJigInMapKeys } = require('../../util/misc2')

// TODO
//    -publish ... set bindings how to know if dependents
...
Record._transaction = function (callback) {
  ...
  try {
    ...
    try { record._rollback(e) } catch (e) { }
