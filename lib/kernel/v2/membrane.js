...
class Membrane {
  ...
  get (target, prop, receiver) {
    ...
    // Return the actual function prototypes, never a proxy of them. They are immutable.
    ...
    // If val is a blockchain object, return it directly
    const Code = require('./code')
    if (val instanceof Code || val instanceof Jig || val instanceof Berry) {
      return val
    }

    // If val is a method on this object, wrap it. Do this before checking if instanceof Code.
