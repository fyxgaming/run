 ...
 * code.js
 *
 * Enables the creation and use of CodeJig instances
 */
...
// Code doesn't know what's on the object. Just enables upgrades. Everything else is
// managed by the repository, that knows about the actual code, how to deploy, sandbox, etc.
...
class Code {
   ...
   */
  _setType (T) {
    const CodeJig = require('./code-jig.js')
    ...
    if (!_parent(T)) Object.setPrototypeOf(T, CodeJig.prototype)
