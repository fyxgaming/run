...
class Editor {
  ...
  _setupBehavior (T, local = false, newCode = []) {
    ...
    // Make sure we do not allow berries to be upgraded
    const berryUpgradeError = 'Cannot upgrade berry classes'
    _checkState(!(this._installed && _extendsFrom(this._T, Berry)), berryUpgradeError)
