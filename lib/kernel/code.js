...
function checkOptions (T) {
  ...
  if (_hasOwnProperty(T, 'upgradable')) {
    const badUpgradable = `Invalid upgradable option: ${T.upgradable}`
    _checkArgument(T.upgradable === true || T.upgradable === false, badUpgradable)
  }
}
