...
class Code {
  ...
  constructor (T, local = true, newCode = []) {
    ...
    const Membrane = require('../membrane-old')
...
class Editor {
  ...
  _install (T, local = true, newCode = []) {
    ...
    try {
      ...
      if (_extendsFrom(T, Jig)) {
        this._membrane._inner = require('../membrane-old')._JIG_CODE
      } else {
        this._membrane._inner = require('../membrane-old')._SIDEKICK_CODE
      }
  ...
  _installNative (T, internal = false) {
    ...
    this._membrane._inner = require('../membrane-old')._NATIVE_CODE
