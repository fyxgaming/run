...
class Code {
  static async sync () {
    const { _assert, _Membrane, _Bindings, _Log, _Repository, _Record } = Context

    _assert(!_Repository._isNative(this), 'Native code may not be synced')

    _Log._info('Sync', this)
