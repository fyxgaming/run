...
class Code {
  ...
  upgrade (T, local = true) {
    ...
    console.log('###0', Record._CURRENT_RECORD._reads.length)
    console.log('###0', Record._CURRENT_RECORD._nested)
    ...
    try {
      ...
      console.log('###', Record._CURRENT_RECORD._reads.length)
      console.log('###', Record._CURRENT_RECORD._nested)
