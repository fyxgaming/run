...
class Membrane {
  ...
  ownKeys (target) {
    ...
    if (this._fromInstanceOfDifferentJigClass()) {
      return Reflect.ownKeys(this._target).filter(key => key[0] !== '_')
    } else {
  ...
  // --------------------------------------------------------------------------
  // _fromInstanceOfOtherJigClass
  // --------------------------------------------------------------------------

  _fromInstanceOfDifferentJigClass () {
    // TODO
  }
