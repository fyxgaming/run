...
const throwNativeImmutableError = () => { throw new Error('Native code is immutable') }

// Native code cannot be changed. The traps enforce this.
NATIVE_TRAPS.defineProperty = () => throwNativeImmutableError()
NATIVE_TRAPS.deleteProperty = () => throwNativeImmutableError()
NATIVE_TRAPS.isExtensible = () => false
NATIVE_TRAPS.preventExtensions = () => throwNativeImmutableError()
NATIVE_TRAPS.set = () => throwNativeImmutableError()
NATIVE_TRAPS.setPrototypeOf = () => throwNativeImmutableError()
