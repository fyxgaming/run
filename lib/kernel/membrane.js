...
class Membrane {
  ...
  _apply (target, thisArg, args) {
    ...
    return this._captureErrors(() => {
      ...
      // Jig.init is not recordable, even through the jig records calls. This is by design,
      // because instantiation has a special top-level new action.
      let passThrough = !membrane || !membrane._rules._recordCalls || !this._rules._recordable
      ...
      if (passThrough && typeof thisArg === 'function' && !(thisArg instanceof Jig)) {
        ...
        passThrough = !membrane || !membrane._rules._recordCalls || !this._rules._recordable
      }
