...
const {
  ...
  _getOwnProperty, _deterministicCompareKeys, _isBasicSet, _isBasicMap, _defineGetter
} = require('../util/misc')
...
const CODE_METHODS = { }
_defineGetter(CODE_METHODS, 'toString', () => makeCodeMethod('toString'))
_defineGetter(CODE_METHODS, 'sync', () => makeCodeMethod('sync'))
_defineGetter(CODE_METHODS, 'upgrade', () => makeCodeMethod('upgrade'))
_defineGetter(CODE_METHODS, 'destroy', () => makeCodeMethod('destroy'))
_defineGetter(CODE_METHODS, 'auth', () => makeCodeMethod('auth'))
_defineGetter(CODE_METHODS, Symbol.hasInstance, () => makeCodeMethod(Symbol.hasInstance))
