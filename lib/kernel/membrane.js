...
const {
  ...
  _PROTECTED_CODE_METHOD_NAMES, _PROTECTED_JIG_METHOD_NAMES, _PROTECTED_BERRY_METHOD_NAMES,
...
const CODE_METHOD = name => Object.getPrototypeOf(require('./code').prototype)[name]
...
class Membrane {
  ...
  _defineProperty (target, prop, desc) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isProtectedCodeMethod(prop)) throw new Error(`Cannot define ${prop}`)
  ...
  _deleteProperty (target, prop) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isProtectedCodeMethod(prop)) throw new Error(`Cannot delete ${prop}`)
  ...
  _get (target, prop, receiver) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isProtectedCodeMethod(prop) && _RESERVED_CODE_METHODS.includes(prop)) {
  ...
  _getOwnPropertyDescriptor (target, prop) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isProtectedCodeMethod(prop)) return undefined
  ...
  _has (target, prop) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isProtectedCodeMethod(prop)) return true
  ...
  _set (target, prop, value, receiver) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isProtectedCodeMethod(prop)) throw new Error(`Cannot set ${prop}`)
  ...
  _isProtectedCodeMethod (prop) { return this._rules._codeMethods && _PROTECTED_CODE_METHOD_NAMES.includes(prop) }
  _isProtectedJigMethod (prop) { return this._rules._jigMethods && _PROTECTED_JIG_METHOD_NAMES.includes(prop) }
  _isProtectedBerryMethod (prop) { return this._rules._berryMethods && _PROTECTED_BERRY_METHOD_NAMES.includes(prop) }
