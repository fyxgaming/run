...
class MethodHandler {
  ...
  apply (target, thisArg, args) {
    ...
    _assert(thisArg[this._name] === this._proxy, 'Jig methods must only be applied to their instances')
    ...
    const nonJigCode = false
    if (nonJigCode) return Reflect.apply(target, undefined, args)
