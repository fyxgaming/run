...
class Membrane {
  ...
  _get (target, prop, receiver) {
    ...
    return this._trap(() => {
      ...
      // Wrap this object with a membrane
  ...
  _getOwnPropertyDescriptor (target, prop) {
    ...
    return this._trap(() => {
      ...
      // Wrap this object in a membrane
  ...
  _intrinsicOut (value) {
    ...
    return this._trap(() => {
      ...
      // Add a membrane for this object
  ...
  _wrapForExport (value, parentJig) {
    // If there is no parent, then it doesn't need to be wrapped. No protection.
  ...
  _getParentJig (prop) {
    ...
    while (!_hasOwnProperty(target, prop)) {
      ...
      if (this._rules._recordReads) RECORD()._read(parentJig)
    }
