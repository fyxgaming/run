...
class Membrane {
  ...
  _apply (target, thisArg, args) {
    ...
    return this._captureErrors(() => {
      ...
      let passThrough = !membrane || !membrane._rules._recordCalls || !this._rules._recordableTarget
      ...
      if (passThrough && typeof thisArg === 'function' && !(thisArg instanceof Jig)) {
        ...
        passThrough = !membrane || !membrane._rules._recordCalls || !this._rules._recordableTarget
      }
