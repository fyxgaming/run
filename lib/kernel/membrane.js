...
const {
  ...
  _getOwnProperty, _deterministicCompareKeys, _basicSet, _basicMap, _defined, _deterministicDefineProperty, _basicUint8Array
} = require('../util/misc')
...
function checkSetValidDescriptor (desc, mustBeConfigurable = true) {
  ...
  if (mustBeConfigurable && !desc.configurable) throw new StateError('Descriptor must be configurable')
