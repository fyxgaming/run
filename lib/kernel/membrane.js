...
class Membrane {
  ...
  _get (target, prop, receiver) {
    ...
    return this._trap(() => {
      ...
      value = this._wrapWithParentRules(value, parentJig)
  ...
  _getOwnPropertyDescriptor (target, prop) {
    ...
    return this._trap(() => {
      ...
      // Wrap this object with a membrane that enforces parent rules
      desc.value = this._wrapWithParentRules(desc.value, this._jig)
  ...
  _intrinsicOut (value) {
    ...
    return this._trap(() => {
      ...
      // Wrap this object with a membrane that enforces parent rules
      value = this._wrapWithParentRules(value, this._jig)
  ...
  // --------------------------------------------------------------------------
  // _wrapWithParentRules
  // --------------------------------------------------------------------------

  _wrapWithParentRules (value, parentJig) {
