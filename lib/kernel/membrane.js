...
class Membrane {
  ...
  _get (target, prop, receiver) {
    ...
    if (typeof value === 'object' || typeof value === 'function') {
      const rules = Rules._childPropertyOf(this)
...
class Rules {
  ...
  static _childProperty(jig) {
  }

  equals(rules) {
    _assert(Objects.keys(rules).length === Object.keys(this).length)
