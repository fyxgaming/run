...
class Membrane {
  ...
  _defineProperty (target, prop, desc) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isBerryMethod(prop)) throw new Error(`Cannot define ${prop}`)
  ...
  _deleteProperty (target, prop) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isBerryMethod(prop)) throw new Error(`Cannot delete ${prop}`)
  ...
  _get (target, prop, receiver) {
    ...
    return this._captureErrors(() => {
      ...
      // TODO
      // Jig methods, other than init which
  ...
  _getOwnPropertyDescriptor (target, prop) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isBerryMethod(prop)) return undefined
  ...
  _has (target, prop) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isBerryMethod(prop)) return true
  ...
  _set (target, prop, value, receiver) {
    ...
    return this._captureErrors(() => {
      ...
      if (this._isBerryMethod(prop)) throw new Error(`Cannot set ${prop}`)
  ...
  _checkReserved (prop) {
    ...
    if (this._rules._berryMethods) _checkState(!_RESERVED_BERRY_METHODS.includes(prop), error)
  }
  ...
  _isBerryMethod (prop) { return this._rules._berryMethods && BERRY_METHOD_NAMES.includes(prop) }
