...
NATIVE_TRAPS.set = function (target, prop, value, receiver) {
  console.log('native set', target, receiver.name, '-', prop, '-', value)
  throwNativeError()
}
NATIVE_TRAPS.setPrototypeOf = (target, prototype) => {
  console.log('NATIVE SPO')
  throwNativeError()
}
...
const sandboxedNativeToString = Sandbox._sandboxType(nativeToString, { Code })[0]
