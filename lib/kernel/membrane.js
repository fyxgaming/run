...
class Membrane {
  ...
  _apply (target, thisArg, args) {
    ...
    return this._captureErrors(() => {
      ...
      return RECORD()._capture(() => {
        ...
        return this._wrapForExport(ret, thisArg, returning, methodPendingMembranes)
      })
    })
  }
  ...
  _wrapForExport (value, parentJig, returning, methodPendingMembranes, unclaimedSet = new Set()) {
    ...
    if (unclaimed) {
      ...
      _sudo(() => {
        const replacer = x => this._wrapForExport(x, parentJig, returning,
