...
class Membrane {
  ...
  _get (target, prop, receiver) {
    ...
    return this._trap(() => {
      ...
      value = this._wrapForExport(value, parentJig)
  ...
  _getOwnPropertyDescriptor (target, prop) {
    ...
    return this._trap(() => {
      ...
      // Wrap this object with a membrane that enforces parent rules
      desc.value = this._wrapForExport(desc.value, this._jig)
  ...
  _intrinsicOut (value) {
    ...
    return this._trap(() => {
      ...
      // Wrap this object with a membrane that enforces parent rules
      value = this._wrapForExport(value, this._jig)
  ...
  _wrapForExport (value, parentJig) {
    // TODO
