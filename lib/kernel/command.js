...
const _COMMANDS = ['deploy', 'upgrade', 'destroy', 'auth']
...
function _auth (record, jig) {
  ...
  const owner = Membrane._sudo(() => jig.owner)

  _assert(!(owner instanceof Unbound && !owner._value), 'Cannot auth: owner unbound')
...
module.exports = { _COMMANDS, _deploy, _upgrade, _destroy, _auth }
