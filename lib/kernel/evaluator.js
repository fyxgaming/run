...
const { _codeToGetIntrinsics } = require('../util/intrinsics')
...
class Evaluator {
  constructor (kernel) {
    ...
    Object.assign(this._sandboxIntrinsics, this.deterministicEnv)
  }
  ...
  evaluate (code, env = {}) {
    ...
    // Don't replace Set and Map when using the global evaluator
      return this.globalEvaluator.evaluate(code, Object.assign({}, this.deterministicEnv, env))
    }
  }
