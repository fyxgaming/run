...
class Berry {
  constructor (...args) {
    ...
    if (!BerryControl.BerryClass || BerryControl.BerryClass !== this.constructor) {
...
async function _pluckBerry (location, blockchain, code, BerryClass) {
  ...
  const oldBerryClass = BerryControl.BerryClass
  ...
  try {
    ...
    BerryControl.BerryClass = SandboxedBerryClass
    ...
    BerryControl.BerryClass = oldBerryClass
