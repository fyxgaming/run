...
class Context {
  ...
  static _deployable (x) { return require('../util')._deployable(x) }
  ...
  static _checkNoObjectsBelongingToOtherTokens (x) {
    return require('../util')._checkNoObjectsBelongingToOtherTokens(x)
  }
