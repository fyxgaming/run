...
function _init (jig) {
  ...
  Membrane._sudo(() => {
    jig.origin = _UNDEPLOYED
    jig.location = _UNDEPLOYED
    jig.nonce = -1
...
module.exports = { _location, _nonce, _owner, _satoshis, _init, _JIG, _USER, _BINDINGS, _UNDEPLOYED }
