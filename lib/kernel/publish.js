...
const { _assert, _bsvNetwork, _addJigs, _checkState, _Timeout, _safeJSONStringify } = require('../util/misc')
...
function createPartialTx (commit, payloadJson) {
  ...
  const payload = Buffer.from(_safeJSONStringify(payloadJson), 'utf8')
