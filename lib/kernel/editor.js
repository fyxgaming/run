...
const {
  _text, _kernel, _parent, _anonymous, _defined, _sameCreation, _CODE,
...
class Editor {
  ...
  _installNative (T, internal = false) {
    ...
    if (_hasOwnProperty(T, 'sealed')) _setOwnProperty(S, 'sealed', sealed)
    if (_hasOwnProperty(T, 'upgradable')) _setOwnProperty(S, 'upgradable', upgradable)
