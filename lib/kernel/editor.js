...
class Editor {
  ...
  _setupBehavior (T, local = false, newCode = []) {
    ...
    _addMembranesToPrototypeMethods(S, this._C)
...
function _addMembranesToPrototypeMethods (S, C) {
  ...
  methods.forEach(method => {
    const Membrane = require('./membrane')
    const owned = false
    const methodRules = Rules._childProperty(C, true, owned)
