...
const {
  _text, _kernel, _parent, _anonymous, _defined, _sameCreation,
...
function checkDeps (T, ParentCode) {
  ...
  if (ParentCode) {
    ...
    if (DepParent && !_sameCreation(DepParentCode, ParentCode)) throw new ArgumentError('Parent dependency mismatch')
  }
...
function lookupNativeCodeByName (name) {
  ...
  _assert(!EDITORS.get(C)._internal)
