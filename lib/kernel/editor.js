...
class Editor {
  _init (C, D) {
    ...
    try { this._network = _kernel()._blockchainWrapper().network } catch (e) { }
  ...
  _postinstall () {
    ...
    this._network = _kernel()._blockchainWrapper().network
...
function lookupCodeByType (T) {
  ...
  let network = ''
  try { network = _kernel()._blockchainWrapper().network } catch (e) { }
