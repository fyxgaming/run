...
const { _assert, _text, _parent, _hasCreation, _hasOwnProperty, _defined } = require('../util/misc')
...
function _pluck (berryClass, berry, args) {
  ...
  // don't allow and actions and will roll it back at the end. TODO: Revisit this to make
  // sure it is safe.
