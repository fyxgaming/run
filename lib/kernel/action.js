...
class _UpgradeAction extends _Action {
  ...
  toString () { return `Upgrade ${this._jig}` }
}
...
class _DestroyAction extends _Action {
  toString () { return `Destroy ${this._jig}` }
}
...
class _AuthAction extends _Action {
  toString () { return `Auth ${this._jig}` }
}
...
class _CallAction extends _Action {
  ...
  toString () { return `Call ${this._jig} ${this._method}` }
}
...
function _deploy (jigs) {
  ...
  const CURRENT_RECORD = require('./record')._current()
