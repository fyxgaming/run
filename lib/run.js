...
class Run {
  ...
  set inventory (inventory) {
    ...
    this._inventory = parseInventory(inventory, false)
...
function parseApi (api) {
  if (typeof api !== 'undefined' && api !== 'run' && api !== 'mattercloud' && api !== 'whatsonchain') throw new Error(`Invalid api: ${api}`)
  return api
}
...
function parseApiKey (apiKey) {
  if (typeof apiKey !== 'undefined' && typeof apiKey !== 'string') throw new Error(`Invalid apiKey: ${apiKey}`)
  return apiKey
}
...
function parseInventory (inventory, specified) {
  ...
  if (specified) throw new Error(`Invalid inventory: ${inventory}`)
