...
const Jig2 = require('./kernel/v2/jig')
...
class Run {
  ...
  async load2 (location, _BerryClass) {
    this._checkActive()
    return this._kernel._load2(location, { _BerryClass })
  }
...
Run._util._Codec = require('./util/codec')
...
Run._util._SafeSet = require('./util/safe').SafeSet
Run._util._SafeMap = require('./util/safe').SafeMap
Run._util._Snapshot = require('./util/snapshot')
