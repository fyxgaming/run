...
function parseApi (api, specified, blockchain, network) {
  ...
  if (api === 'mattercloud') {
    throw new Error('MatterCloud API is no longer supported')
  }
...
_defineGetter(Run.extra, 'NFT', () => require('./extra/nft'))
...
Run.util.recreateJigsFromStates = require('./kernel/functions/recreate-jigs-from-states')
