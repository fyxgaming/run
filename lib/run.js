...
function parseTimeout (timeout) {
  switch (typeof timeout) {
    case 'number':
      if (Number.isNaN(timeout) || timeout < 0) throw new Error(`Invalid timeout: ${_text(timeout)}`)
      return timeout
    case 'undefined': return 30000
    default: throw new Error(`Invalid timeout: ${_text(timeout)}`)
  }
}
...
function parsePreverify (preverify) {
  switch (typeof preverify) {
    ...
    default: throw new Error(`Invalid preverify: ${_text(preverify)}`)
  }
}
...
function parseRollbacks (rollbacks) {
  switch (typeof rollbacks) {
    ...
    default: throw new Error(`Invalid rollbacks: ${_text(rollbacks)}`)
  }
}
