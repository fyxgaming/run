...
class Run {
  ...
  set api (api) {
    ...
    this._kernel._blockchain = parseBlockchain(undefined, false, this._kernel._cache, this._kernel._client, api, this._apiKey, this.network)
  ...
  set apiKey (apiKey) {
    ...
    this._kernel._blockchain = parseBlockchain(undefined, false, this._kernel._cache, this._kernel._client, this._api, apiKey, this.network)
  ...
  set network (network) {
    ...
    this._kernel._blockchain = parseBlockchain(undefined, false, this._kernel._cache, this._kernel._client, this._api, this._apiKey, network)
