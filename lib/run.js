...
class Run {
  ...
  constructor (options = {}) {
    ...
    this._kernel._purse = parsePurse(options.purse, this._kernel._blockchainWrapper(), options.wallet)
  ...
  set owner (owner) {
    this._kernel._owner = parseOwner(owner, this._kernel._blockchainWrapper(), null, true)
    if (this._inventory) this._inventory.detach(this)
...
function parseOwner (owner, blockchain, wallet, specified) {
  ...
  if ((typeof owner === 'undefined' && !specified) || typeof owner === 'string' || owner instanceof PrivateKey) {
    try {
