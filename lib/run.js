...
const IndexedDbCache = require('./module/indexeddb-cache')
...
Run.module.IndexedDbCache = IndexedDbCache
...
_defineGetter(Run, 'IndexedDbCache', () => { warnModule('IndexedDbCache'); return IndexedDbCache })
