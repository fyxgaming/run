...
function parseBlockchain (options) {
  switch (options.network) {
    case 'mock': return new Mockchain()
    case 'main': return new BlockchainApi({ api: options.api, network: options.network })
    case 'test': return new BlockchainApi({ api: options.api, network: options.network })
