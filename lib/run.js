...
class Run {
  ...
  constructor (options = {}) {
    ...
    this._kernel._blockchain = parseBlockchain(options.blockchain, keys.includes('blockchain'), this._api, this._apiKey, options.network, this._kernel._cacheAPI())
  ...
  set api (api) {
    ...
    this._kernel._blockchain = parseBlockchain(undefined, false, api,
      this._apiKey, this.blockchain.network, this._kernel._cacheAPI())
  ...
  set network (network) {
    this._kernel._blockchain = parseBlockchain(undefined, false, this._api,
      this._apiKey, network, this._kernel._cacheAPI())
