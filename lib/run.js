...
const Repository = require('./kernel/repository.js')
...
// Kernel
Run._Repository = Repository
Run._JigHandler = require('./kernel/code-jig')._JigHandler
Run.Berry = Berry
Run.Jig = Jig
...
Run._util._ResourceSet = require('./util/set').ResourceSet
Run._util._ResourceMap = require('./util/set').ResourceMap
...
Object.assign(Run._util, require('./util/resource'))
