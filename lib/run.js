...
const RunSDKPurse = require('./plugins/run-sdk-purse')
...
function hookPlugins (run) {
  ...
  if (run._kernel._purse instanceof RunSDKPurse) run._kernel._owner.hook()
}
...
Run.plugins.RunSDKPurse = RunSDKPurse
