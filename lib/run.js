...
// Module
const { BlockchainServer, MatterCloud, WhatsOnChain, RemoteBlockchain } = require('./module/blockchain-server')
...
class Run {
  constructor (options = {}) {
    ...
    this._kernel._blockchain = parseBlockchain(options, this._kernel._state)
...
Run._util._ResourceSet = require('./util/datatypes').ResourceSet
Run._util._ResourceMap = require('./util/datatypes').ResourceMap
