...
const { ResourceSet, ResourceMap } = require('./util/datatypes')
...
Run._util.ResourceJSON = require('./util/json')
Run._util.ResourceSet = ResourceSet
Run._util.ResourceMap = ResourceMap
