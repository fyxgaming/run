...
function parseTrust (trust) {
  ...
  extras.filter(extra => extra.presets).forEach(extra => {
    if (extra.presets.main) trust.push(extra.presets.main.location.slice(0, 64))
    if (extra.presets.test) trust.push(extra.presets.main.location.slice(0, 64))
  })
