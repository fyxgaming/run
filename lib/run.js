...
const WrappedBlockchain = require('./plugins/wrapped-blockchain')
...
function hookPlugins (run) {
  if (run._kernel._blockchain instanceof WrappedBlockchain) {
...
Run.plugins.WrappedBlockchain = WrappedBlockchain
