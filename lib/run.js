...
class Run {
  constructor (options = {}) {
    ...
    this._kernel._codeWhitelist = typeof options.codeWhitelist === 'undefined' ? null : options.codeWhitelist
  ...
  get codeWhitelist () { return this._kernel._codeWhitelist }
  set codeWhitelist (value) { this._kernel._codeWhitelist = value }
