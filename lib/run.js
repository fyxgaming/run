...
_defineGetter(Run.module, 'RunDB', () => { warnPlugins('RunDB', rm); return RunConnect })
...
Run.util.metadata = rawtx => require('./kernel/loader')._payload(new bsv.Transaction(rawtx))
...
// Install utils for backwards compatibility
Run.prototype.payload = Run.util.metadata
