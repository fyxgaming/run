...
// Module
const BrowserCache = require('./module/browser-cache')
...
const MultiLevelCache = require('./module/multi-level-cache')
...
function parseCache (cache) {
  ...
  if (typeof cache === 'undefined') {
    ...
    return new MultiLevelCache(new LocalCache(), new BrowserCache())
  }
...
// Module
Run.module = {}
Run.module.BrowserCache = BrowserCache
...
Run.module.MultiLevelCache = MultiLevelCache
...
_defineGetter(Run, 'BrowserCache', () => { warnModule('BrowserCache'); return BrowserCache })
...
_defineGetter(Run, 'MultiLevelCache', () => { warnModule('MultiLevelCache'); return MultiLevelCache })
