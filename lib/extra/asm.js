...
function asm (s) {
  ...
  for (const part of parts) {
    ...
    // Hex data
    const bytes = hex(part.length === 1 ? '0' + part : part)
...
asm.originMainnet = '87cd529983d7fa5e0fc3c70a0d6f488f9f251aaffd3c86aea5f88ac364895795_o1'
asm.locationMainnet = '87cd529983d7fa5e0fc3c70a0d6f488f9f251aaffd3c86aea5f88ac364895795_o1'
asm.ownerMainnet = '13HMuzt7FMHiicG2Pi4PLkJopkzydQGcug'

asm.originTestnet = '10a88faafc164b73957e0bdf983d9168e6d7a83fea4a5c68669e331cda07188b_o1'
asm.locationTestnet = '10a88faafc164b73957e0bdf983d9168e6d7a83fea4a5c68669e331cda07188b_o1'
asm.ownerTestnet = 'mpPoB3cgrvUz9rxp9zqDGHUYNBVMWs2Xy7'
