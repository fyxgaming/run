...
function asm (s) {
  ...
  for (const next of tokens) {
    ...
    if (typeof asm.OP_CODES[next] !== 'undefined') {
      out.push(asm.OP_CODES[next])
      continue
    }

    // Hex data
    const bytes = hex(next)
...
asm.originMainnet = '25def710bb116f273da51f23990a479a896c47e6a14cb400de8bcf04d25045ab_o1'
asm.locationMainnet = '25def710bb116f273da51f23990a479a896c47e6a14cb400de8bcf04d25045ab_o1'
asm.ownerMainnet = '1Nxo7mYtMiAsf45nAs7G2YQMZShF51EVbL'

asm.originTestnet = 'c4a6c11468dd51e9701daf94980758a9296cf345961a06e934a9cb6556770f8a_o1'
asm.locationTestnet = 'c4a6c11468dd51e9701daf94980758a9296cf345961a06e934a9cb6556770f8a_o1'
asm.ownerTestnet = 'miWpRckBkgvJi1199ZwvM8UyMLk2fAgntR'
