...
// Support load here
// Test serialize with custom protocol to create deployable
// Test if the protocol is not deployed already
...
class Protocol {
  ...
  static get (x) {
    ...
    return Protocol.protocols[protocolIndex]
  }
