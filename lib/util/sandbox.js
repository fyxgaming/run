...
class Sandbox {
  constructor () {
    ...
    this._intrinsics.Map = this._sandboxType(SafeMap, SafeMap.deps)[0]
    this._intrinsics.Set = this._sandboxType(SafeSet, SafeSet.deps)[0]
  ...
  _sandboxType (T, env) {
    if (global.RUN_SANDBOX_EXCLUDES && global.RUN_SANDBOX_EXCLUDES.includes(T)) {
