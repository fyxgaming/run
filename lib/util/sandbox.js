...
class Sandbox {
  ...
  constructor () {
    ...
    this._intrinsics.Map = this._sandboxType(TokenMap, TokenMap.deps)[0]
    this._intrinsics.Set = this._sandboxType(TokenSet, TokenSet.deps)[0]
  ...
  _evaluate (code, env = {}) {
    ...
    Object.assign(compartment.global, this._intrinsics)
