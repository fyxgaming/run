...
const { _isBasicArray, _isBasicObject, _text, _isBasicSet, _isBasicMap, _isBasicUint8Array, _isArbitraryObject } = require('./misc')
...
function _deepReplace (x, callback, visited = new Map()) {
  ...
  if (typeof x2 === 'function' && X !== HO.getPrototypeOf(HO) && X !== SO.getPrototypeOf(SO)) {
    ...
    if (Object.getPrototypeOf(x2) !== Y) Object.setPrototypeOf(x2, Y)

    // Code jigs have two prototypes for every class
    const proto = x2 instanceof Code ? Object.getPrototypeOf(x2.prototype) : x2.prototype
    if (Object.getPrototypeOf(proto) !== Y.prototype) Object.setPrototypeOf(proto, Y.prototype)
  }
 ...
 *
 * Tokens are not cloned but passed through. This is because they are designed to cross sandbox
