...
// Location flags
const _USER = 1 // Must have an onchain txid and vout or vdel
 ...
 * @returns {txid, vout, vdel, path, error, record, vjig, native} Parsed locations. Fields are optional.
 */
...
function _init (jig) {
  ...
  Membrane._sudo(() => {
    jig.origin = 'error://Not deployed'
    jig.location = 'error://Not deployed'
    jig.nonce = -1
...
module.exports = { _location, _nonce, _owner, _satoshis, _init, _USER, _BINDINGS }
