...
const _BINDINGS = ['location', 'origin', 'owner', 'satoshis']
...
function _location (s, flags) {
  ...
  if (match) {
    ...
    if (groups.protocol === 'record') { ret.record = true }
...
module.exports = { _location, _owner, _satoshis, _USER, _JIG, _BERRY, _BINDINGS, _Unbound }
