...
const RECORD_LOCATION = /^(?<protocol>record):\/\/(?<recordid>[a-f0-9]+)_j(?:(?<vjig>[0-9]+))$/
 ...
 * @returns {txid, vout, vdel, vjig, berry, error, undeployed, commitid, recordid, nativeid} Parsed locations. Fields are optional.
 */
