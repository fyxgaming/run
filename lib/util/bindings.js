 ...
 * @returns {txid, vout, vdel, path, error, undeployed, commit, vjig, native} Parsed locations. Fields are optional.
 */
function _location (s, flags) {
  ...
  if (match) {
    ...
    if (groups.protocol === 'commit') { ret.commit = 'commit://' + groups.commit }
