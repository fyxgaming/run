...
function _deepTraverseSubObjects (x, callback, visited) {
  ...
  if (x instanceof Sandbox._host._intrinsics.Set || (x instanceof Sandbox._instance._intrinsics.Set)) {
    for (const value of x) visit(value)
  }

  // Traverse map keys and values
  if (x instanceof Sandbox._host._intrinsics.Map || (x instanceof Sandbox._instance._intrinsics.Map)) {
