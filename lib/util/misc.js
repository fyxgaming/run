...
// Some methods like sign and destroy are safe to call inside other methods. Therefore, they
...
const _RESERVED_CODE_METHODS = [
  ...
  'sign', // eventually sign should not be reserved
...
const _FINAL_JIG_PROPS = [..._RESERVED_JIG_METHODS, 'init'] // destroy and sign are not protected
