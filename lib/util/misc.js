...
// Protected words are properties which cannot be set/deleted/changed in any way
const _PROTECTED_CODE_METHOD_NAMES = [..._RESERVED_CODE_METHODS]
const _PROTECTED_JIG_METHOD_NAMES = [..._RESERVED_JIG_METHODS, 'init'] // destroy and auth are not protected
const _PROTECTED_BERRY_METHOD_NAMES = [..._RESERVED_BERRY_METHODS, 'init']
...
module.exports = {
  ...
  _PROTECTED_CODE_METHOD_NAMES,
  _PROTECTED_JIG_METHOD_NAMES,
  _PROTECTED_BERRY_METHOD_NAMES,
  _kernel,
  _assert,
  _bsvNetwork,
  _parent,
