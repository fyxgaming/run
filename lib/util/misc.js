...
class _Type {
  static _protoLen (x) { if (!x) return 0; let n = 0; do { n++; x = Object.getPrototypeOf(x) } while (x); return n }
  static _isBasicObject (x) { return x && _Type._protoLen(x) === 2 }
  static _isBasicArray (x) { return Array.isArray(x) && _Type._protoLen(x) === 3 }
  static _isUndefined (x) { return typeof x === 'undefined' }
}
