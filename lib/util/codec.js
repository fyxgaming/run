...
const {
  _text, _isBasicObject, _isBasicArray, _isUndefined, _isBasicSet, _isBasicMap, _isBasicUint8Array
} = require('./misc')
  ...
  // This check works on all intrinsics, host or sandbox
    ...
    // Check if there are any special props
      ...
      if ($ === '$ui8a') {
        ...
        // Safari doesn't like TypedArray.from for some reason so we do new Uint8Array() instead.
        return new this._OI.Uint8Array(buf)
      }
