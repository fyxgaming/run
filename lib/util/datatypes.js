...
// ------------------------------------------------------------------------------------------------
// _tokenSetHasLocation
// ------------------------------------------------------------------------------------------------

/**
 * Internal method to directly check if a location is present in our TokenSet. We use this as an
 * optimization within our Inventory.
 * @param {TokenSet} tokenSet TokenSet to check
 * @param {string} location Location to check
 */
function _tokenSetHasLocation (tokenSet, location) {
  // Todo
}
