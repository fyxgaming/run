...
class DynamicHandler {
  ...
  isExtensible (target) {
    // Dynamic types are always extensible
    return true
  }
  ...
  _setInnerType (T, proxy) {
    ...
    while (true) {
      ...
      // The types must be extensible
      _checkArgument(Object.isExtensible(x), 'Types must be extensible')
