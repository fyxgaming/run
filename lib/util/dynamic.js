...
class DynamicHandler {
  ...
  getOwnPropertyDescriptor (target, prop) {
    // Type is a special property that does not have a property descriptor!
    if (prop === '__type__') return undefined
  ...
  _setInnerType (T, proxy) {
    ...
    _checkArgument(!('__type__' in T), `__type__ is a reserved property: ${T}`)
