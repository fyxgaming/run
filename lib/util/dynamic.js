 ...
 * with special methods Dynamic._getInnerType and Dynamic._setInnerType.
 *
...
class Dynamic {
  ...
  static _getInnerType (D) { return HANDLERS.get(D)._innerType }
  static _setInnerType (D, T) { HANDLERS.get(D)._setInnerType(T) }
}
