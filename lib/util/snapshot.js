...
class Snapshot {
  /**
   * Creates a savepoint for a jig, code, or berry so that it can be rolled back if necessary
  ...
  /**
   * If we had previously only captured the creation's bindings, then we can capture the rest here
   */
  _captureCompletely () {
