...
function _scripthash (script) {
  script._hash = script._hash || _sha256(script.toBuffer()).reverse().toString('hex')
  return script._hash
}
...
function _sha256 (data) {
  return bsv.crypto.Hash.sha256(data)
}
...
module.exports = { _patchBsv, _calculateDust, _scripthash, _sighash, _signature, _sha256 }
