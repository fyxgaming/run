...
function _calculateDust (scriptLen) {
  ...
  return Math.ceil(3 * nSize * Transaction.FEE_PER_KB / 1000)
}
...
module.exports = { _patchBsv, _calculateDust, _scripthash, _sighash, _signature }
