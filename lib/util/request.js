 ...
 * @param {function} options.onresponse Response handler that runs for real responses, not dups/cached
...
async function request (url, options = {}) {
  ...
  const response = await dedup(REQUESTS, id, async () => {
  ...
  if (requested && options.onresponse) {
