...
_defineGetter(Log, '_infoOn', () => Log._logger && Log._logger.info && typeof Log._logger.info === 'function')
_defineGetter(Log, '_warnOn', () => Log._logger && Log._logger.warn && typeof Log._logger.warn === 'function')
_defineGetter(Log, '_errorOn', () => Log._logger && Log._logger.error && typeof Log._logger.error === 'function')
_defineGetter(Log, '_debugOn', () => Log._logger && Log._logger.debug && typeof Log._logger.debug === 'function')
