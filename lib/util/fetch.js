 ...
 * fetch.js
 *
 * Helpers to use fetch() to make network requests.
 */
...
async function _fetchWithTimeout (url, timeout = 2000, options = {}) {
...
module.exports = { _fetchWithTimeout, _parseJsonResponse }
