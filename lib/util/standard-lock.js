 ...
 * standard-lock.js
 *
 * The most common lock to create a P2PKH output for an token's address
 */
 ...
 *
 * When you set an address string or a public key string as the owner of a token, Run generates
