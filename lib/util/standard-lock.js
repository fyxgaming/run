...
StandardLock.sealed = true

// ------------------------------------------------------------------------------------------------

StandardLock.toString() // Preserves the class name during compilation

const NativeStandardLock = new Code()
const editor = Code._editor(NativeStandardLock)
const internal = true
editor._installNative(StandardLock, internal)

module.exports = NativeStandardLock
