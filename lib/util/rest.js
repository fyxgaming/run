...
class REST {
  static async _get (url, headers = {}) {
    return REST._request(url, 'GET', undefined, REST._timeout, headers)
  }

  static async _post (url, body, headers = {}) {
    return REST._request(url, 'POST', body, REST._timeout, headers)
  }
