 ...
 * as class properties, or passed as functions. If we were to support a new kind of object, we
 * would start by supporting it here.
 *
 ...
 * several. If a replacer or reviver function returns a non-falsey value, then it is used.
 */
class TokenJSON {
  /**
...
function _convertTokensToRefs (getLocation) {
...
function _convertRefsToToken (getToken) {
...
TokenJSON._convertTokensToRefs = _convertTokensToRefs
TokenJSON._convertRefsToToken = _convertRefsToToken
