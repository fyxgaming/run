...
const { _resourceType, _text } = require('./misc')
const { ResourceMap, ResourceSet } = require('./set')
...
class ResourceJSON {
  ...
  static _serialize (x, opts = {}) {
    ...
    opts._cache = opts._cache || new ResourceMap() // X -> JSON
    opts._dups = opts._dups || new ResourceSet() // [X]
