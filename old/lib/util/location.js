 ...
 * location.js
 *
 * Parses and builds location strings that point to resources on the blockchain
 */

/**
 * Helper class to create and parse location strings
 *
 * Every resource in Run is stored at a location on the blockchain. Both the "origin"
 ...
 * turned into a real location when the resource's transaction is known and published.
